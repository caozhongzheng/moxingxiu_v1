...
//	private BitmapManager bmpManager;
	...
	public Main_Adapter2(Context context, ArrayList<MainTimelineItem_Model> listitems) {
...
//		this.bmpManager = new BitmapManager();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = listParentContainer.inflate(R.layout.listitem2_layout, null);
		} 
		
		RelativeLayout ls_r = ViewHolder.get(convertView, R.id.ls_r);
		View marin_top_view = ViewHolder.get(convertView, R.id.marin_top_view_r);
		ImageView main_adapter_item_image = ViewHolder.get(convertView, R.id.main_adapter_item_image);
		ImageView main_adapter_item_image_ra = ViewHolder.get(convertView, R.id.main_adapter_item_image_ra);
...
//		bmpManager.loadBitmap(item.getImgPath(), holder.k_listview_item_image, DensityUtil.dip2px(context, context.getResources().getDimension(R.dimen.k_listview_item_image_width)), DensityUtil.dip2px(context, context.getResources().getDimension(R.dimen.k_listview_item_image_height)));
...
//		linearParams.width = LayoutParams.WRAP_CONTENT;// 控件的宽强制设成30 
		...
		if ("news".equals(type)) {
//			ls_r.setBackgroundResource(R.drawable.news_ls_right);
			main_adapter_item_image_ra.setVisibility(View.INVISIBLE);
			main_adapter_item_type.setImageResource(R.drawable.main_adapter_item_xw);
		}
		else if ("video".equals(type)) {
//			ls_r.setBackgroundResource(R.drawable.video_ls_right);
			main_adapter_item_image_ra.setVisibility(View.INVISIBLE);
			main_adapter_item_type.setImageResource(R.drawable.main_adapter_item_bf);
		}
		else if ("face".equals(type)) {
//			ls_r.setBackgroundResource(R.drawable.face_ls_right);
			main_adapter_item_image_ra.setVisibility(View.VISIBLE);
			main_adapter_item_type.setImageResource(R.drawable.main_adapter_item_bq);
		}
		else if ("game".equals(type)) {
//			ls_r.setBackgroundResource(R.drawable.game_ls_right);
			main_adapter_item_image_ra.setVisibility(View.INVISIBLE);
