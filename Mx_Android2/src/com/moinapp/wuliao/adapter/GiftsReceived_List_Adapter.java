...
public class GiftsReceived_List_Adapter extends BaseAdapter {
	...
	public GiftsReceived_List_Adapter(Activity context, ArrayList<OpenGift_List_Model> listitems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		gift_type.setText(mContext.getResources().getString(R.string.from));
