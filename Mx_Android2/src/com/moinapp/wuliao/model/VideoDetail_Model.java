...
public class VideoDetail_Model implements Serializable {

	private VideoDetail_Content_Model detail;
	private Reply_Model reply;
	private RecentUser_Model recentUser;
	private Recommend_Model recommend;

	public VideoDetail_Content_Model getDetail() {
		return detail;
	}

	public void setDetail(VideoDetail_Content_Model detail) {
		this.detail = detail;
	}
