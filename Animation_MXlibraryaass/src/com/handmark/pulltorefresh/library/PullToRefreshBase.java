...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        boolean isVisibleBottom = false;
        if(a.hasValue(R.styleable.PullToRefresh_ptrBottomAnimationisInVisible)) {
        	isVisibleBottom = a.getBoolean(R.styleable.PullToRefresh_ptrBottomAnimationisInVisible, false);
        }
        mFooterLayout.setVisibleBottom(isVisibleBottom);
